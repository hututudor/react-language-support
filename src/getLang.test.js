...
describe('getLang function', () => {
  ...
  it('should return empty if no currentLanguage is provided', () => {
    expect(
      getLang({ languages: { en: {} }, currentLanguage: '' }, '', {})
    ).toBe('');
  });
  ...
  it('should return empty if no index found in language', () => {
    expect(
      getLang({ languages: { en: {} }, currentLanguage: 'en' }, 'test', {})
    ).toBe('');
  });
  ...
  it('should return the correct string without replacements', () => {
    expect(
      getLang(
        { languages: { en: { test: 'Test' } }, currentLanguage: 'en' },
        'test',
        {}
      )
    ).toBe('Test');
  ...
  it('should return the correct string with one replacement', () => {
    expect(
      getLang(
        { languages: { en: { test: 'Test {{test}}' } }, currentLanguage: 'en' },
        'test',
        {
          test: 'test'
        }
